...
invaderImg.src = "images/invader.png"; // Adjust the path if necessary

let playerImg = new Image();
playerImg.src = "images/player.png"; // Adjust the path if necessary
...
PlayState.prototype.draw = function(game, dt, ctx) {
    ...
    //  Draw ship.
    ctx.drawImage(playerImg, this.ship.x - (this.ship.width / 2), this.ship.y - (this.ship.height / 2), this.ship.width, this.ship.height);
